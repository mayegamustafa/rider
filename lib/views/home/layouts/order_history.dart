...
class _OrderHistoryState extends ConsumerState<OrderHistory> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      backgroundColor:
          context.isDark ? Colors.black : AppColor.greyBackgroundColor,
      body: Column(
        children: [
          Container(
                            ...
                            child: ListView.builder(
                              ...
                              itemBuilder: (context, index) {
                                return _OrderHistoryCard(
                                  ...
                                  orderId:
                                      orderList.orders[index].orderCode
                                          .toString(),
                                  customerName:
        ...
        InkWell(
          ...
          child: Container(
            ...
            decoration: ShapeDecoration(
              color:
                  context.isDark ? Colors.grey.withOpacity(0.3) : Colors.white,
                        ...
                        child: Row(
                          ...
                          children: [
                            ...
                            Container(
                              ...
                              decoration: ShapeDecoration(
                                color:
                                    GlobalFunction.orderStatusText(
                                      status,
                                      context,
                                    ).bgColor,
                                shape: RoundedRectangleBorder(
                  ...
                  children: [
                    ...
                    Expanded(
                      child: Container(
                        ...
                        child: SvgPicture.asset(Assets.svgs.line),
                      ),
                    ),
                    Expanded(
                      child: Row(
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return Container(
      ...
      child: SingleChildScrollView(
        ...
        child: Row(
          children: List.generate(TodoListFilter.values.length, (index) {
                ...
                InkWell(
                  ...
                  child: Container(
                    ...
                    decoration: BoxDecoration(
                      ...
                      border: Border.all(
                        color:
                            selectedOrderHistory == TodoListFilter.values[index]
                      ...
                      localize(
                        ...
                        title == "All"
                            ...
                            ? ref
                                ...
                                .maybeWhen(
                                  orElse: () => '0',
                                  data: (value) => value.toDeliver.toString(),
                                )
                            : ref
                                .watch(orderHistoryProvider)
                                .maybeWhen(
                                  orElse: () => '0',
                                  data: (value) => value.delivered.toString(),
                                ),
                      ),
        ...
        children: [
          ...
          Expanded(
            child: Column(
              crossAxisAlignment: CrossAxisAlignment.start,
              children: [
                Text(S.of(context).orderHistory, style: AppTextStyle.title),
                Text(
