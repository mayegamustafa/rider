...
class S {
  ...
  String get numberMustBeDigit {
    return Intl.message(
      'Number must be at least digit',
      name: 'numberMustBeDigit',
      desc: '',
      args: [],
    );
  }

  /// `Number must be max digit`
  String get numberWillbeMaxDigit {
    return Intl.message(
      'Number must be max digit',
      name: 'numberWillbeMaxDigit',
      desc: '',
      args: [],
    );
  }
